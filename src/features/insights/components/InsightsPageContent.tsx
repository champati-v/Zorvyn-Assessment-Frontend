...
export default function InsightsPageContent() {
  ...
  const range: DateRangeKey = "quarter";
    ...
    <TooltipProvider>
      <div className="space-y-6">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    Combination of mock data and the data stored locally.
                  </TooltipContent>
                </Tooltip>
              </div>
            </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
          ...
          <Card className="h-full">
            ...
            <CardContent className="space-y-3">
              {signals.map((signal) => (
                <InsightSignalItem key={signal.title} {...signal} />
              ))}
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
          <SpendingPie transactions={visibleTransactions} size="lg" />
